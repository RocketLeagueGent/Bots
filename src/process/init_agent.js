...
// Never let a single rejected promise (e.g. a missing native module) kill a bot.
process.on('unhandledRejection', (reason) => {
    console.error('[init_agent] Unhandled rejection (ignored):', reason);
});
process.on('uncaughtException', (err) => {
    console.error('[init_agent] Uncaught exception (ignored):', err);
});
